...
def storeCityGML(suffix):
    ...
    citygmlFile.write("<!-- David Kitavi - 3D Cadastre, Technical University of Kenya -->\n")
...
for b in buildings:
    ...
    if len(b.findall('origin')) < 1:
        print('origin is less than 1')
        pass
    elif len(b.findall('order')) < 1:
        print('order is less than 1')
        pass
    elif len(b.findall('rotation')) < 1:
        print('rotation is less than 1')
        pass
    elif len(b.findall('xSize')) < 1:
        print('xSize is less than 1')
        pass
    elif len(b.findall('ySize')) < 1:
        print('ySize is less than 1')
        pass
    elif len(b.findall('zSize')) < 1:
        print('zSize is less than 1')
        pass
    elif len(b.findall('floors')) < 1:
        print('floors is less than 1')
        pass
    elif len(b.findall('floorHeight')) < 1:
        print('floorHeight is less than 1')
        pass
    elif len(b.findall('embrasure')) < 1:
        print('embrasure is less than 1')
        pass
    elif len(b.findall('wallThickness')) < 1:
        print('wallthickness is less than 1')
        pass
    elif len(b.findall('joist')) < 1:
        print('joist is less than 1')
        pass
    elif len(b.findall('properties')) < 1:
        print('properties is less than 1')
        pass
    elif len(b.findall('roof')) < 1:
        print('roof is less than 1')
        pass
    elif len(b.findall('door')) < 1:
        print('door is less than 1')
        pass
    elif len(b.findall('windows')) < 1:
        print('window is less than 1')
        pass
    else:
        print(b)
        if REPORT:
